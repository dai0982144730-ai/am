...
| **9** | Personalization engine: taste profile, embeddings, mood-theo-giờ, cold-start onboarding — **hồ sơ gu + gu theo khung giờ + khởi động nguội xong 2026-08-16**; **embeddings vẫn bị chặn** vì bản PostgreSQL portable ở máy nhà không có pgvector và cũng không cài thêm được. Hồ sơ dựng chủ yếu từ 1.029 tín hiệu tài khoản YouTube, không phải từ hành vi trong app (39 phiên, không phiên nào xem hết) |
