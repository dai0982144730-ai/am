...
| **9** | Personalization engine: taste profile, embeddings, mood-theo-giờ, cold-start onboarding — **hồ sơ gu + gu theo khung giờ + khởi động nguội xong 2026-08-16**; **pgvector cài xong 2026-08-17** (dựng từ mã nguồn, xem CLAUDE.md), cột `vector` và chỉ mục HNSW đã sẵn sàng nhưng **chưa có dòng embedding nào** — còn thiếu bước gọi Voyage AI sinh embedding cho nội dung/ghi chú rồi ghi vào cột. Hồ sơ gu hiện dựng chủ yếu từ 1.029 tín hiệu tài khoản YouTube, không phải từ hành vi trong app (39 phiên, không phiên nào xem hết) |
